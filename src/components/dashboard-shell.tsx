...
export function DashboardShell({
  ...
  return (
    <main className="min-h-screen px-4 py-4 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] w-full max-w-7xl overflow-hidden rounded-[2rem] border border-white/10 bg-[#0a0813]/95 shadow-[0_30px_120px_rgba(0,0,0,0.45)] lg:grid-cols-[272px_1fr]">
        <aside className="border-b border-white/8 bg-[linear-gradient(180deg,rgba(13,10,24,0.98),rgba(9,8,18,0.98))] p-5 lg:border-b-0 lg:border-r">
          ...
          <div className="mt-10 space-y-3 rounded-[1.6rem] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-4">
          ...
          <div className="mt-8 rounded-[1.7rem] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(196,181,253,0.18),transparent_30%),linear-gradient(180deg,rgba(28,20,49,0.96),rgba(15,11,29,0.96))] p-4">
        ...
        <div className="flex min-w-0 flex-col bg-[radial-gradient(circle_at_top_right,rgba(167,139,250,0.16),transparent_24%),linear-gradient(180deg,rgba(9,8,18,0.96),rgba(7,6,14,0.98))]">
          <header className="border-b border-white/8 px-5 py-4 sm:px-6">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex items-center gap-3 rounded-full border border-white/10 bg-white/4 px-4 py-3 text-sm text-slate-400">
                  <Search className="h-4 w-4" />
                  <span>Server snapshots, players, routes</span>
                </div>
                <div className="flex items-center gap-3">
                  <button className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-white/4 text-slate-200">
          ...
          <section className="flex-1 overflow-hidden px-5 py-5 sm:px-6">
...
export function HighlightPanel({
  ...
  return (
    <section className="grid gap-6 rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(166,139,250,0.24),rgba(18,13,31,0.96)_45%,rgba(8,7,14,0.98))] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] lg:grid-cols-[1.05fr_0.95fr]">
      <div className="space-y-4">
        <h2 className="max-w-xl text-3xl font-semibold tracking-tight text-white">{title}</h2>
        <p className="max-w-xl text-sm leading-7 text-slate-300">{description}</p>
        <button className="rounded-full bg-[linear-gradient(135deg,#d8ccff,#a78bfa)] px-5 py-3 text-sm font-semibold text-[#171126] shadow-[0_14px_34px_rgba(167,139,250,0.28)] transition hover:scale-[1.01]">
          {cta}
        </button>
      </div>
      <div className="rounded-[1.7rem] border border-white/8 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.08),transparent_26%),linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.02))] p-4">
        {meta}
      </div>
    </section>
  );
...
export function DashboardTable({
  ...
  return (
    <section className="rounded-[2rem] border border-white/10 bg-[#110d1d]/92 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
